...
window.onload = function () {
  ...
  // structure 1
  const projects = ["House Wallet", "Sure Wheels", "Binge Watcher Test", "BookArt Shop", "Pour Elle", "Ducktionary", "Tic-Tac-Toe", "What's Your Age"];
  ...
  projectSource["Binge Watcher Test"] =
    "https://mariamatef226.github.io/binge-watcher-test/";
  ...
  aboutProject["Sure Wheels"] =
   ...
   The database is implemented using RDBMS - MySQL and the backend is implemented using PHP. The frontend was done\
    using HTML, CSS, Bootstrap4/5 and JavaScript. It was a team project for uni. I was responsible for the backend portion,\
     ...
     aboutProject["Binge Watcher Test"] = "A simple quiz app using React.js. This solo project is the final project for Bob Ziroll's 'Learn React' course on Scrimba.\
